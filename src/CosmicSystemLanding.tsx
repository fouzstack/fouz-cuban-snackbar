...
/* const GravityIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <circle cx="12" cy="12" r="10" strokeWidth="1.5" />
    <path d="M12 2v20" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M2 12h20" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M4.93 4.93l14.14 14.14" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M4.93 19.07l14.14-14.14" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
 */
...
/* const MagneticFieldIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none" stroke="currentColor">
    <circle cx="12" cy="12" r="9" strokeWidth="2" />
    <path d="M12 3v18" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M3 12h18" strokeWidth="1.5" strokeLinecap="round" />
    <path d="M12 3l4 8-4 8-4-8 4-8z" strokeWidth="1.5" fill="currentColor" opacity="0.3" />
  </svg>
); */
